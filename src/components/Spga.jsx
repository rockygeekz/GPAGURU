  ...
  return (
    <div className="absolute top-0 left-0 min-h-fit min-w-full container mt-10">
      <form action="" className="lg:mt-32" onSubmit={modSubmit}>
        <div className="text-white inputs grid gap-y-8 lg:gap-y-12 mt-20 lg:mt-12 lg:grid-cols-2 lg:grid-rows-4 text-center max-h-[50rem] lg:text-xl">
          <div className="I-1">
          ...
          Introduction to electrical engineering<br></br>
            <input
              ...
              className="mx-3 rounded-lg text-black btn-class mt-3 "
              placeholder="Marks"
              onChange={modchange}
             />
          </label>
          ...
          <label htmlFor="">
            ...
            <input
              ...
              className="mx-3 rounded-lg text-black btn-class mt-3 "              placeholder="Marks"
              onChange={modchange}
            />
          </label>
