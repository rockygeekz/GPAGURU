    ...
    <div className="absolute top-0 left-0 min-h-fit min-w-full container mt-10 ">
      <form action="" onSubmit={modSubmit}  >
        <div className="inputs font-medium  ">
          <div className="left flex flex-col justify-center mt-40 gap-y-5 text-white  min-w-full p-9 font-mono text-center  text-xl">
            <label htmlFor="">
              1st semester
              <input
                type="number"
                name="sem1"
                className="m-3 rounded-lg text-black h-10 w-56 px-8 outline-none "
                placeholder="Sgpa"
